...
WORK_START=env.int("WORK_START", default=10)
WORK_END=env.int("WORK_END", default=20)
GRID_STEP=env.int("GRID_STEP", default=10)
LOCK_TIMEOUT=env.int("LOCK_TIMEOUT", default=5)